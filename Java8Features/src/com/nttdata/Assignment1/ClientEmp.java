...
public class ClientEmp {
	...
	List<Employee>list=new ArrayList<>();
		...
		list.stream().filter(p->(p.sal>10000 && p.sal<20000)).forEach(p->System.out.println(p.sal+(p.sal*5/100)));
		System.out.println("number of employees at particular location");
